...
public class FXMLDocumentController implements Initializable {
    ...
    public void loginBtn() {
        if (si_username.getText().isEmpty() || si_password.getText().isEmpty()) {
            ...
            String selctData = "SELECT username, password FROM employee WHERE BINARY username = ? AND BINARY password = ?";
    ...
    private String[] questionList = {
        "What was the name of the first person who taught you how to ride a bike?",
        "What was the name of your favorite childhood stuffed animal or toy?",
        "What was the first concert you ever attended, and who did you go with?",
        "What was the name of your favorite elementary school cafeteria worker?",
        "What was the title of the first book you remember reading on your own?",
        "What was the name of the first beach you ever visited?",
        "What was the model of the first electronic device (e.g., phone, game console) you owned?",
        "What was the name of the first person you had a significant disagreement with?",
        "What was the nickname your family had for you when you were a child?",
        "What was the first recipe you learned to cook by yourself?"
    };
    ...
    public void switchForn(ActionEvent event) {
